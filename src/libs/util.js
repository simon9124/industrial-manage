...
export const TOKEN_KEY = "token-gateway";
...
/**
 * @param {Array} list 通过路由列表得到菜单列表 - 原项目封装
 * @returns {Array}
 */
...
export const setTagNavListInLocalstorage = list => {
  localStorage["tagNaveList-template"] = JSON.stringify(list);
};
/**
 * @returns {Array} 其中的每个元素只包含路由原信息中的name, path, meta三项
 */
export const getTagNavListFromLocalstorage = () => {
  const list = localStorage["tagNaveList-template"];
